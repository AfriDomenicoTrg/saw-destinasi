...
@section('page-description', 'Edit data kriteria yang sudah ada')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 mt-1">
                    <span class="text-green-600">Benefit:</span> Nilai besar = lebih baik<br>
                    <span class="text-red-600">Cost:</span> Nilai kecil = lebih baik
                </p>
                @error('tipe')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                        <span class="text-gray-500">× 100 = <span id="bobotPersen">{{ $kriteria->bobot * 100 }}</span>%</span>
                    </div>
                </div>
        ...
        <div class="mt-6 p-4 bg-blue-50 rounded-lg">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                    ...
                    <span class="text-sm text-gray-700">Total bobot keseluruhan:</span>
                </div>
